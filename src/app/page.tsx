      ...
      <nav className="fixed top-0 w-full z-50 bg-white/10 backdrop-blur-md border-b border-white/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          ...
          <button
            ...
            className="px-6 py-2 bg-white text-violet-600 rounded-lg font-semibold hover:bg-gray-100 transition"
          >
            Ingresar
          </button>
        </div>
      ...
      <div className="pt-32 pb-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <button
              onClick={() => router.push('/dashboard')}
              className="px-8 py-3 bg-white text-violet-600 rounded-lg font-semibold hover:bg-gray-100 transition shadow-lg"
            >
              Comenzar ahora
            </button>
            <button
